...
class OldAttendanceScreen extends StatefulWidget {
  ...
  @override
  State<OldAttendanceScreen> createState() => _OldAttendanceScreenState();
}

class _OldAttendanceScreenState extends State<OldAttendanceScreen>
  ...
  //           SnackBar(
  //             content: Text(l10n.alreadyCheckedInSnack(_checkInTime)),
  ...
  //           SnackBar(
  //             content: Text(
  //               AppLocalizations.of(context)!.successCheckedOutShort,
  //             ),
  ...
  //           SnackBar(
  //             content: Text(
  //               AppLocalizations.of(context)!.successCheckedInShort,
  //             ),
  //             backgroundColor: Colors.green,
  //           ),
  //         );
  ...
  //         SnackBar(
  //           content: Text(
  //             AppLocalizations.of(context)!.failedUpdateAttendanceShort,
  //           ),
  ...
  //                         ? AppLocalizations.of(
  //                             context,
  //                           )!.checkedInSinceUseLogout(_checkInTime)
