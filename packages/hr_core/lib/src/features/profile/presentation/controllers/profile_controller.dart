...
import 'package:hr_core/src/features/profile/data/repositories/profile_repository_impl.dart';
import 'package:hr_core/src/features/profile/domain/repositories/profile_repository.dart';
import 'package:hr_core/src/features/profile/presentation/widgets/change_lang_widget.dart';
...
class ProfileController extends GetxController {
  ...
  HrEmployee profileData = HrEmployee();
  ...
  Future<void> getProfileData() async {
    ...
    if (result != null) {
      profileData = result;
      log(name: 'getProfileData', 'result: ${profileData.profile?.name} ');
      update();
    }
    loading.value = false;
  }
